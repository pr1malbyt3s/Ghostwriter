    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.TextField(blank=True, help_text='Provide a description for this finding that introduces it', null=True, verbose_name='Details')),
                ('likelihood', models.TextField(blank=True, help_text='Describe the likelihood in terms of risk', null=True, verbose_name='Likelihood')),
                ('impact', models.TextField(blank=True, help_text='Describe the impact in terms of risk', null=True, verbose_name='Impact')),
                ('recommendation', models.TextField(blank=True, help_text='Describe how this finding can be resolved or addressed', null=True, verbose_name='Recommendation')),
                ('source', models.TextField(blank=True, help_text='Provide an explanation for sources used to identify finding.', null=True, verbose_name='Source')),
                ('tools', models.TextField(blank=True, help_text='Describe tools used to identify finding.', null=True, verbose_name='Tools')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tools', models.TextField(blank=True, help_text='Describe tools used to identify finding.', null=True, verbose_name='Tools')),
                ('references', models.TextField(blank=True, help_text='Provide solid references for this finding, such as links to reference materials, tooling, and white papers', null=True, verbose_name='References')),
                ('additional_guidance', models.TextField(blank=True, help_text='Provide notes for your team that describes how the finding is intended to be used and any details that should be provided during editing', null=True, verbose_name='Additional Guidance')),
                ('finding_type', models.ForeignKey(help_text='Select a finding category that fits', null=True, on_delete=django.db.models.deletion.PROTECT, to='reporting.FindingType')),
                ('severity', models.ForeignKey(help_text='Select a severity rating for this finding that reflects its role in a system compromise', null=True, on_delete=django.db.models.deletion.PROTECT, to='reporting.Severity')),
            ],
            options={
